...
/**
 * 对DefaultListableBeanFactory进行了扩展,主要用于对XML文档中读取BeanDefinition
 * 对于注册和获取Bean都是使用从父类DefaultListableBeanFactory继承而来的方法实现的
 * 不同
 * 唯独不同于父类的个性化实现就是增加了XmlBeanDefinitionReader类型的reader属性
 * 在该类中主要使用reader属性对资源文件进行读取和注册。
 */
@Deprecated
...
public class XmlBeanFactory extends DefaultListableBeanFactory {
	 ...
	 * @throws BeansException in case of loading or parsing errors
	 */
	//parentBeanFactory为父类用于factory的合并，可以为空
